...
+ We will cover the projection of population using matrix models.
...
+ Lectures to Master students with Olivier Duriez.
...
+ Estimating abundance and density of populations     
      ...
      + Capture-recapture, N-mixture and line transect samplings
      + Introduction to unmarked
...
+ Questions and answers via the chat.

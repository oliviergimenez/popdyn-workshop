...
+ Discrete and continuous covariates (including age)
+ Introduction to RMark
+ Productivity estimation

+ âge sur la survie et fécondité, et mentionner l’accession à la repro dans le mutliétat
...
```{r, echo=FALSE, out.width="60%", fig.cap="", fig.align='center'}
knitr::include_graphics("img/cjs-binarytree.png")
```
...
node [label = 'alive \n and present', fontcolor = 'orange']
b

node [label = 'dead \n or emigrated', fontcolor = 'orange']
c

node [label = 'detected', fontcolor = 'orange']
d

node [label = 'non-detected', fontcolor = 'orange']
e

node [label = 'alive \n and present', fontcolor = 'green']
f

node [label = 'dead \n or emigrated', fontcolor = 'green']
g
...
node [label = 'detected', fontcolor = 'green']
j

node [label = 'non-detected', fontcolor = 'green']
k
